						...
						<div>
							...
							>
								<span class="flex w-full justify-between items-center">
									...
									<fa-icon :icon="['fal', 'sort-down']" class="flex-shrink-0 h-5 w-5 text-gray-400 group-hover:text-gray-500" title="SelectorIcon" />
								</span>
							</MenuButton>
						</div>
						<transition
					...
					<div class="px-3 mt-5">
						...
						<div class="mt-1 relative rounded-md shadow-sm">
							<div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none" aria-hidden="true">
								<fa-icon :icon="['fal', 'search']" class="mr-3 h-4 w-4 text-gray-400" title="SearchIcon" />
							</div>
							<input
								type="text"
								name="search"
		...
		<div class="flex flex-col w-0 flex-1 overflow-hidden">
			...
			<div class="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:hidden">
				<button class="px-4 border-r border-gray-200 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-purple-500 lg:hidden" @click="sidebarOpen = true">
					...
					<fa-icon :icon="['fal', 'bars']" class="h-6 w-6" title="MenuAlt1Icon" />
				</button>
						...
						<form class="w-full flex md:ml-0" action="#" method="GET">
							...
							<div class="relative w-full text-gray-400 focus-within:text-gray-600">
								<div class="absolute inset-y-0 left-0 flex items-center pointer-events-none">
									<fa-icon :icon="['fal', 'search']" class="h-5 w-5" title="SearchIcon" />
								</div>
								<input
									id="search-field"
									name="search-field"
							...
							<div class="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">
								...
								<Menu as="div" class="flex-shrink-0 pr-2">
									...
									>
										...
										<fa-icon :icon="['fal', 'ellipsis-v']" class="w-5 h-5" title="DotsVerticalIcon" />
									</MenuButton>
									<transition
										enter-active-class="transition ease-out duration-100"
										enter-from-class="transform opacity-0 scale-95"
					...
					<ul class="mt-3 border-t border-gray-200 divide-y divide-gray-100">
						<li v-for="project in projects" :key="project.id">
							<a href="#" class="group flex items-center justify-between px-4 py-4 hover:bg-gray-50 sm:px-6">
								...
								<fa-icon :icon="['fal', 'chevron-right']" class="ml-4 h-5 w-5 text-gray-400 group-hover:text-gray-500" title="ChevronRightIcon" />
							</a>
						</li>
					</ul>
				</div>
								...
								<tr v-for="project in projects" :key="project.id">
									...
									<td class="px-6 py-3 text-sm text-gray-500 font-medium">
										<div class="flex items-center space-x-2">
											...
											<span v-if="project.totalMembers > project.members.length" class="flex-shrink-0 text-xs leading-5 font-medium"
												...
												>
													<div class="py-1">
														<MenuItem v-slot="{ active }">
															...
															>
																<fa-icon :icon="['fal', 'edit']" class="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500" title="PencilAltIcon" />
																Edit
															</a>
														</MenuItem>
														<MenuItem v-slot="{ active }">
															...
															>
																<fa-icon :icon="['fal', 'clone']" class="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500" title="DuplicateIcon" />
																Duplicate
															</a>
														</MenuItem>
														<MenuItem v-slot="{ active }">
															...
															>
																<fa-icon :icon="['fal', 'user-plus']" class="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500" title="UserAddIcon" />
																Share
															</a>
														</MenuItem>
													</div>
													<div class="py-1">
														<MenuItem v-slot="{ active }">
															...
															>
																<fa-icon :icon="['fal', 'trash-alt']" class="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500" title="TrashIcon" />
																Delete
															</a>
														</MenuItem>
													</div>
...
//import { ChevronRightIcon, DotsVerticalIcon, DuplicateIcon, PencilAltIcon, SearchIcon, SelectorIcon, TrashIcon, UserAddIcon } from '@heroicons/vue/solid';
